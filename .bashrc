...
# Last Modified: mardi 06 octobre 2020, 18:43
# Edit Time: 65:40:59
# Description: 
...
#
# $Id: .bashrc,v 1.235 2020/10/06 16:47:20 czo Exp $
...
BVERS=`echo '$Id: .bashrc,v 1.235 2020/10/06 16:47:20 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//'`
