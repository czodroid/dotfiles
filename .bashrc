...
# Last Modified: dimanche 17 octobre 2021, 19:07
# Edit Time: 94:20:38
# Description:
...
#
# $Id: .bashrc,v 1.345 2021/10/17 17:21:44 czo Exp $
...
BVERS=$(echo '$Id: .bashrc,v 1.345 2021/10/17 17:21:44 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
