...
# Last Modified: mardi 06 octobre 2020, 19:02
# Edit Time: 65:41:17
# Description: 
...
#
# $Id: .bashrc,v 1.236 2020/10/06 17:03:48 czo Exp $
...
BVERS=`echo '$Id: .bashrc,v 1.236 2020/10/06 17:03:48 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//'`
