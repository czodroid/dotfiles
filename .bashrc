...
# Last Modified: jeudi 15 juillet 2021, 13:23
# Edit Time: 92:44:37
# Description:
...
#
# $Id: .bashrc,v 1.335 2021/07/15 13:04:02 czo Exp $
...
BVERS=$(echo '$Id: .bashrc,v 1.335 2021/07/15 13:04:02 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
