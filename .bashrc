...
# Last Modified: samedi 12 février 2022, 14:41
# Edit Time: 102:19:48
# Description:
...
#
# $Id: .bashrc,v 1.386 2022/02/12 13:42:51 czo Exp $
...
BVERS=$(echo '$Id: .bashrc,v 1.386 2022/02/12 13:42:51 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
