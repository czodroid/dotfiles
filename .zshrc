...
# Last Modified: samedi 03 octobre 2020, 17:06
# Edit Time: 110:47:16
# Description:
...
#
# $Id: .zshrc,v 1.187 2020/10/05 10:26:46 czo Exp $
...
BVERS=`echo '$Id: .zshrc,v 1.187 2020/10/05 10:26:46 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//'`
SHELLNAME='zsh'
