...
# Last Modified: samedi 09 janvier 2021, 17:39
# Edit Time: 127:09:17
# Description:
...
#
# $Id: .zshrc,v 1.223 2021/01/21 17:48:04 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.223 2021/01/21 17:48:04 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
