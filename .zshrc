...
# Last Modified: samedi 23 janvier 2021, 16:21
# Edit Time: 127:23:16
# Description:
...
#
# $Id: .zshrc,v 1.225 2021/01/23 15:22:44 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.225 2021/01/23 15:22:44 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
