...
# Last Modified: dimanche 06 septembre 2020, 19:50
# Edit Time: 104:36:20
# Description:
...
#         reconnaissant.
#
# $Id: .zshrc,v 1.156 2020/09/06 17:52:23 czo Exp $
...
BVERS=`echo '$Id: .zshrc,v 1.156 2020/09/06 17:52:23 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//'`
