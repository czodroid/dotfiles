...
# Last Modified: jeudi 15 juillet 2021, 15:05
# Edit Time: 130:24:12
# Description:
...
#
# $Id: .zshrc,v 1.302 2021/06/05 16:14:40 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.302 2021/06/05 16:14:40 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
