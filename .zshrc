...
# Last Modified: Friday 19 November 2021, 02:24
# Edit Time: 130:51:53
# Description:
...
#
# $Id: .zshrc,v 1.327 2021/11/19 01:25:17 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.327 2021/11/19 01:25:17 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
