...
# Last Modified: lundi 07 septembre 2020, 20:16
# Edit Time: 104:56:09
# Description:
...
#         reconnaissant.
#
# $Id: .zshrc,v 1.158 2020/09/09 23:20:19 czo Exp $
...
BVERS=`echo '$Id: .zshrc,v 1.158 2020/09/09 23:20:19 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//'`
