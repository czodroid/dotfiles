...
# Last Modified: mardi 02 mars 2021, 12:27
# Edit Time: 128:40:27
# Description:
...
#
# $Id: .zshrc,v 1.238 2021/03/02 11:47:14 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.238 2021/03/02 11:47:14 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
