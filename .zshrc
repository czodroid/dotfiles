...
# Last Modified: mercredi 10 novembre 2021, 20:04
# Edit Time: 130:50:47
# Description:
...
#
# $Id: .zshrc,v 1.323 2021/11/10 19:11:28 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.323 2021/11/10 19:11:28 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
