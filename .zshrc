...
# Last Modified: jeudi 18 novembre 2021, 21:46
# Edit Time: 130:51:20
# Description:
...
#
# $Id: .zshrc,v 1.325 2021/11/18 16:35:56 czo Exp $
...
BVERS=$(echo '$Id: .zshrc,v 1.325 2021/11/18 16:35:56 czo Exp $' | sed -e 's/^.*,v 1.//' -e 's/ .*$//' 2>/dev/null)
SHELLNAME='zsh'
